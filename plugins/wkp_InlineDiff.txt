 ...
 * upgrade with https://github.com/horde/Text_Diff/ in the future; or http://www.raymondhill.net/finediff/viewdiff-ex.php ?
 */
...
class InlineDiff
{
    ...
    function diff($f1, $f2)
    {
        include_once 'InlineDiff/diff.php';
        include_once 'InlineDiff/renderer.php';
        include_once 'InlineDiff/inline.php';
